...
Currently, the powers that be are leading a dangerous and dysfunctional disclosure campaign. If continued without major overhaul, we may harm each other. If we use the alien presence as a basis for war or deception, humanity’s fate is all but assured.
